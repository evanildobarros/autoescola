...
color:#FFCC33;">Total Geral <?php 
			...
			$sql5 = mysql_query("select sum(valor2) as total from movimento Where mes = '$mes'");
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;movimenta&Ccedil;&Atilde;o cliente devedor</span>
			</form>			</td>
			</tr>
			</table>
			...
			<td width="271"  valign="top" class="td" ><br /></td>
			<td width="198"  valign="top" class="td"><br /></td>
			<td width="158" align="center" valign="top" class="td">
            <td width="74"></td><td width="13"></td><br />
  			<br />
			</tr>
			<?php
			$p = $_GET["p"];
