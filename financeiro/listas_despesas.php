...
color:#999999;">M&ecirc;s  de Origem: <?php echo $mes; ?></div>
 ...
 <div style="margin:-30px 0px 0px 750px; font-family: verdana, arial black;font-size:18px;
color:#FFCC33;">Total Geral <?php 
			
		
			$sql5 = mysql_query("select sum(valor) as total from movimento Where mes = '$mes' AND tipo='1' And status='1'");
			...
			<form name="form2" method="post" action="../listas/layout_despesas_lista.php">
			<label>
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;lista de despesas</span>
			</form>			</td>
			</tr>
			</table>
			...
			<td width="220"  valign="top" class="td" ><br /></td>
			<td width="181"  valign="top" class="td"><br /></td>
			<td width="74" align="center" valign="top" class="td">
            <td></td><br />
  			<br /></td>
			</tr>
			<?php
        ...
        <td valign="top" class="td"><?php if ($resultado['status'] == 1){
               echo "<span class=\"span16\">Pago</span>"; 
               }    ?>            </td>
        <td width="77" valign="top" class="td"><span class="span6">R$&nbsp;<?php $total10 = $resultado['valor']; echo number_format( $total10  , 2 , ',' , '.' ); ?></span></td>
        <td width="111" valign="top" class="td"><div align="center"><a href="../recibo/comprovante_pagamento.php?id_mov=<?php echo $resultado['id_mov']  ?>"><img src="../img/BTR.jpg" /></a></div></td>
        </tr>
        <tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='../listas/layout_despesas_lista.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='../listas/layout_despesas_lista.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='../listas/layout_despesas_lista.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
