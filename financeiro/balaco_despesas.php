...
<br>
<fieldset>
<legend>Despesas</legend><br>


<table width="90%" border="0" style="border-collapse:collapse;" align="center">
 
  
<div class="box_select"><form name="form1" method="POST" action="../listas/layout_despesas_lista.php">
...
<tr>
        ...
        <td bgcolor="#000000"><span class="td" style="font-size:26px; color:<?php if ($s_total2<0) echo "#fd0000"; else echo "#33FF00"?>">R$&nbsp;<?php echo number_format( $s_total2  , 2 , ',' , '.' ); ?></span></td>
    </tr>
  </table>
</div>
