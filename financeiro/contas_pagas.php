...
color:#FFCC33;">Total Geral <?php 
			...
			$sql5 = @mysql_query("select sum(valor) as total from movimento Where mes = '$mes' And tipo ='0' And status='1' ");
			...
			<form name="form2" method="post" action="layout_contas_pagas.php">
			<label>
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;movimenta&Ccedil;&Atilde;o financeiRA CONTAS PAGAS</span>
			</form>			</td>
			</tr>
			</table>
        ...
        <td width="111" valign="top" class="td"><div align="center"><a href="../recibo/comprovante_pagamento2.php?id_mov=<?php echo $resultado['id_mov']  ?>"><img src="../img/BTR.jpg" /></a></div></td>
        </tr>
        <tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_contas_pagas.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_contas_pagas.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_contas_pagas.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
