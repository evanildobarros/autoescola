...
$query_total = "SELECT SUM( mov.valor ) AS valor, ac.filial FROM acesso AS ac, lc_movimento AS mov WHERE ac.usuario = mov.id_cliente and mov.tipo='0' GROUP BY ac.filial";
$total = mysql_query($query_total, $conexao) or die(mysql_error());
$row_total = mysql_fetch_assoc($total);
$totalRows_total = mysql_num_rows($total);

mysql_select_db($database_conexao, $conexao);
$query_total2 = "SELECT SUM(valor) FROM lc_movimento WHERE tipo='0'";
...
<br />
<br />
<fieldset><legend>Total de despesas por lota&ccedil;&atilde;o</legend><br />
<br />
<table width="1000" border="0" align="center" style="border-collapse:collapse;">

  <tr>
    <td width="836" bgcolor="#FFCC00"><span style="color:#FF0000; padding:10px;">Escrit&oacute;rio</span><br /></td>
    <td width="154" bgcolor="#FDE07B"><div align="center" style="color:#FF0033; margin:0px 0px 0px 20px;">Valor</div></td>
  </tr>
  <?php
  $cont = 0;
...
<table width="1000" border="0" align="center" style="border-collapse:collapse;">
  <tr>
    <td width="835" bgcolor="#FFCC00"><span style="color:#666; padding:10px;">
      Total<br />
    </span></td>
    <td width="155" bgcolor="#FDE07B"><div align="center"><span style="color:#FF0000;">R$
