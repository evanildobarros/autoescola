            ...
            $updateSQL = sprintf("UPDATE carga2 SET aluno=%s, qtd=%s, hora=%s WHERE id=%s",
            ...
            mysql_select_db($database_conexao, $conexao);
            $query_carg = sprintf("SELECT * FROM carga2 WHERE id = %s", GetSQLValueString($colname_carg, "int"));
            ...
            <table align="center">
            <tr valign="baseline">
            <td colspan="2" align="right" nowrap="nowrap"><input type="hidden" name="aluno" value="<?php echo htmlentities($row_carg['aluno'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
			...
			$op="Cadastrou carga horária (Simulador) !";
