...
@session_start();
		require'../Connections/conexao.php';	
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;entrega de documentos</span>
			</form>
			</td>
			</tr>
			</table>
			...
			$sql = "SELECT DISTINCT id_aluno, nome,telefone,email,cpf_titular,status,status2 from alunos WHERE nome like '".$filtro."%' ORDER BY id_aluno DESC LIMIT $inicio, $qnt ";
		...
		<tr bgcolor="<?php echo $cor ; ?>">
            ...
            <a class="span11" href="#" onclick="MM_openBrWindow('atualisar_atentimento.php?id_cliente=<?php echo $resultado['id_cliente']; ?>','','scrollbars=yes,resizable=yes,width=300,height=270')"><?php echo $resultado['status']; ?></a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
