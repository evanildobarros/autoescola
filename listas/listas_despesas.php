...
color:#FFCC33;">Total Geral <?php 
			...
			$sql5 = mysql_query("select sum(valor) as total from movimento Where mes = '$mes'");
			...
			<form name="form2" method="post" action="listas_despesas.php">
			<label>
        ...
        <tr><?php $cont ++; }?>
			...
			echo "<a class=\"pag\" href='listas_despesas.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='listas_despesas.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='listas_despesas.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
