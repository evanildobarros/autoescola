...
color:#CC0033;">Total Geral <?php 
			...
			<tr>
			<td bgcolor="#FFFFFF" class="">
			<form name="form2" method="post" action="layout_contas_a_pagar.php">
			<label>
		 ...
		 $sql = "SELECT lcm.id,
						...
						from 
						lc_movimento as lcm,lc_cat as cat WHERE lcm.cat = cat.id AND mes='$mes_hoje' AND lcm.cliente like '".$filtro."%' ORDER BY lcm.vencimento asc LIMIT $inicio, $qnt  ";
        ...
        <td  valign="top"  ><div align="center"><span class="span6">
	   ...
	   ?></span></div></td>
        ...
        <tr><?php $cont ++; }?>
			...
			echo "<a class=\"pag\" href='layout_contas_a_pagar.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_contas_a_pagar.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_contas_a_pagar.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
