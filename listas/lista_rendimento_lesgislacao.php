...
?>
			...
			<form name="form2" method="post" action="layout_rendimento1.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;<span class="span7">SITUA&Ccedil;&Atilde;O DO ALUNO EM RELA&Ccedil;&Atilde;O AO EXAME DE LEGISLA&Ccedil;&Atilde;O </span>
			</form>
			</td>
			</tr>
			</table>
			...
			<td width="174" valign="top" class="td" >&nbsp;</td>
			<td width="168"  valign="top" class="td" ><br /></td>
			<td width="138"  valign="top" class="td"><br /></td>
			...
			$sql = "SELECT * from legislacao WHERE aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
	   ...
	   echo $your_date;
	   ?></td>
        <td width="148" valign="top"  class="td"><font color="#666666"><?php echo $resultado['turno']; ?></td>
        
        <td width="217" align="left" valign="top"  class="td">
        <a class="span8" href="#" 
        onclick="MM_openBrWindow('editar_estatus2.php?id=<?php echo $resultado['id'] ?>','','scrollbars=yes,resizable=yes,width=300,height=190')">
		...
		echo "<span >Aguardando resultado...</span>";
		} 
		?>       </a></td>
        </tr>
        <tr><?php $cont ++; }?>
			...
			echo "<a class=\"pag\" href='layout_rendimento1.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_rendimento1.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_rendimento1.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
