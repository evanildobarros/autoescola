...
?>
        ...
        <td width="684" valign="top" class="td"><font color="#666666"><?php echo $resultado['nome']; ?><font color="#666666"><font color="#666666"></td>
        
        <td width="82" align="left" valign="top" bgcolor="<?php echo $cor ; ?>"  class="td"><a class="span11" href="resultado_mapa.php?nome=<?php echo $resultado['nome'] ?>">Imprimir</a></td>
        </tr>
        <tr><?php $cont ++; }?>
			<?php
