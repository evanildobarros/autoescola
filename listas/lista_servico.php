    ...
    <td width="123" ><span class="font_estilo2"><a style="text-decoration:none; font-weight:bolder;" href="layout_ad_servico.php?id_aluno=<?php echo $resultado['id_aluno'] ?>">[ &Xi; Serviços &Xi; ]</a></span></td>
    </tr>
    <tr><?php $cont ++; }?>
    <?php
