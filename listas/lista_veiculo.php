...
<table width="1000" border="0" align="center" style="border-collapse:collapse;">
			...
			<form name="form2" method="post" action="layout_veiculo_lista.php">
			<label>
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;Adicionar ve&iacute;culo</span>
			</form>
			</td>
			</tr>
			</table>
			...
			<td width="286" valign="top" class="td" >&nbsp;</td>
			...
			<td valign="top" class="td3"><span class="span6"><?php echo $resultado['email']; ?></span></td>
			<td valign="top" class="td3"><span class="span6"><?php echo $resultado['telefone']; ?></span></td>
			<td valign="top" class="td3"><div align="center"><a href="../listas/layout_veiculo.php?id_cliente=<?php echo $resultado['id_cliente'] ?>"><img src="../img/VEICulo.jpg" /></a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_veiculo_lista.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_veiculo_lista.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_veiculo_lista.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
