...
?>   
	...
	<div class="titulo">
	<span class="span1">
	Hoje é <?php echo "$nomediadasemana, $dia de $nomemes de $ano";?><br>
	...
	<div class="box_titulo">Painel de controle</div>
	<div class="box_conteudo"><span class="span4"></span>
	<hr />
	<br>
	<span class="span4"><i class="icon-home icon-white"></i> Usuários Logados no Momento: &nbsp;</span><br><br>
	<br>
	<button type="reset" class="btn btn-primary">ok</button>
	<span class="span4">Total de Clientes Cadastrados:</span>
