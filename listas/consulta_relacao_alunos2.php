...
<br>
    ...
    <form name="form1" method="post" action="../Programacao/consul.php">
...
?>
      ...
      <tr>
        <td width="56">Data:</td>
        <td width="216"><input type="date" name="event_start"></td>
        <td width="216"><input name="button" type="submit" class="botao" id="button" value="Imprimir"></td>
      </tr>
      <tr>
        <td colspan="3">&nbsp;</td>
      </tr>
