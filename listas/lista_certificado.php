...
@session_start();
		require'../Connections/conexao.php';	
			...
			<form name="form2" method="post" action="layout_contrato.php">
			<label>
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;Contrato do aluno</span>
			</form>
			</td>
			</tr>
			</table>
			...
			<td width="229"  valign="top" class="td" >&nbsp;</td>
			<td width="164"  valign="top" class="td"><br /></td>
			<td width="169" colspan="2" align="center" valign="top" class="td"><br />			<br /></td>
			</tr>
			<?php
			$p = $_GET["p"];
    ...
    <td colspan="2" valign="top"><span class="span6"><?php echo $resultado['nome']; ?></span></td>
    <td valign="top" class="td3">&nbsp;</td>
    <td valign="top" class="td3"><div align="center"><a href="../recibo/contrato.php?id_aluno=<?php echo $resultado['id_aluno'] ?>">Contrato</a></div></td>
    <td valign="top" class="td3"><a href="deletar.php?id_aluno=<?php echo $resultado['id_aluno']; ?>"><img src="../img/bt_excluir.PNG" width="26" height="21" /></a></td>
		</tr>
<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_contrato.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_contrato.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_contrato.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
