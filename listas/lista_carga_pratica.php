...
-->
			...
			<td bgcolor="#FFFFFF" class="">
           	  <form name="form2" method="post" action="layout_pratica.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;<span class="span7">&nbsp; &nbsp; &nbsp;Cargar hor&aacute;ria do aluno em rela&ccedil;&atilde;o as aulas Pr&aacute;ticas</span>
			</form>
     ...
     $sql = "SELECT DISTINCT id,aluno,qtd,hora from carga1 WHERE aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt";
...
?> 
        ...
        <td align="left" valign="top"  class="td style1"><div align="center"><a href="#" onclick="MM_openBrWindow('registrar_trafego.php?id=<?php echo $resultado['id']; ?>','','scrollbars=yes,resizable=yes,width=300,height=150')"><img src="../img/BTS.jpg" /></a></div></td>
        </tr>
        <tr><?php $cont ++; }?>
        <?php
        $sql_select_all = "select * from carga1";
        ...
        echo "<a class=\"pag\" href='layout_pratica.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='layout_pratica.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='layout_pratica.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
