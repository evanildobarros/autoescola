...
?>
			...
			<form name="form2" method="post" action="layout_documentacao.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;<span class="span7">anexar documentos</span>
			</form>
			</td>
			</tr>
			</table>
			...
			<td width="299"  valign="top" class="td" ><br /></td>
			<td width="159"  valign="top" class="td"><br /></td>
			<td width="159" colspan="2" valign="top" class="td"><br />			
			  <br />			  <br /></td>
			</tr>
			<?php
			...
			$sql = "SELECT * from cliente WHERE cliente like '".$filtro."%' ORDER BY id_cliente DESC LIMIT $inicio, $qnt";
		...
		<tr bgcolor="<?php echo $cor ; ?>">
			...
			<td valign="top"><a href="#" onclick="MM_openBrWindow('documentacao.php?id_cliente=<?php echo $resultado['id_cliente']; ?>','','scrollbars=yes,resizable=yes,width=600,height=300')"><img src="../img/DOC.jpg"  /></a></td>
		  <td valign="top"><a href="layout_doc.php?id_cliente=<?php echo $resultado['id_cliente'] ?> ?&gt;" ><img src="../img/VIZ.jpg" width="155" height="21" /></a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_documentacao.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_documentacao.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_documentacao.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
