...
for ($i=1;$i<=12;$i++){
    ...
    <?php if($mes_hoje==$i){?>    
    color:#33FFCC; font-size:13px; font-weight:bold; padding:5px; text-decoration:none;
    <?php }else{?>
...
color:#CC0033;">Total Geral <?php 
			...
			$sql5 = mysql_query("SELECT SUM(valor2) as total from lc_movimento WHERE tipo = '1' AND status='2' AND mes='$mes_hoje'");
        ...
        <td valign="middle" class="td"><label>
            <input type="checkbox" name="chkDel[]" value="<?php echo $resultado["id"];?>">
             <span class="span6"><?php echo $resultado['cliente']; ?><?php echo $resultado['fornecedor']; ?></span></td>
             <td valign="middle" valign="top" class="td" width="200">
             <span class="span6">
	   ...
	   echo $your_date;
	   ?></span></div></td>
             <td valign="middle" valign="top" class="td" ><span class="span6"><?php echo $resultado['nome']; ?></span></td>
             <td valign="middle" valign="top" class="td" ><?php if ($resultado['status'] == 2){
               echo "<span class=\"span22\">Em Aberto</span>"; 
               }    ?> </td>
              <td valign="middle"  valign="top" class="td" ><span class="span6">R$&nbsp;<?php $total10 = $resultado['valor2']; 
			  echo number_format( $total10  , 2 , ',' , '.' ); ?></span></td>
              <td valign="middle"  valign="top" class="td" ><span class="span6"> <?php
		      if ($dias >= 10){
            ...
            ?></span></td>
                ...
                <td  valign="top" class="td"><div align="center"><a class="span1"  href="javascript:abrir('baixar2.php?id=<?php echo $resultado['id']; ?>')"><span style="color:#003366; font-family:Arial, Helvetica, sans-serif;" ><img width="80" height="35" src="../img/icon_baixar.gif" /></span></a></div></td>
        </tr>
        <tr><?php $cont ++; }?>
