...
?>
			...
			<form name="form2" method="post" action="layout_reprovados.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;<span class="span7">ALUNOS REPROVADOS NO EXAME DE LEGISLA&Ccedil;&Atilde;O </span>
			</form>
			</td>
			</tr>
			</table>
			...
			$sql = "SELECT * from legislacao WHERE status='2' and aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
	   ...
	   echo $your_date;
	   ?></td>
        <td width="191" valign="top"  class="td"><font color="#666666"><?php echo $resultado['turno']; ?></td>
        
        <td width="63" align="left" valign="top"  class="td">
        <a href="#" 
        ...
        <tr><?php $cont ++; }?>
			...
			echo "<a class=\"pag\" href='layout_reprovados.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_reprovados.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_reprovados.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
