...
?>
			...
			<form name="form2" method="post" action="layout_trafego.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;<span class="span7">Marca Exame JUNTO AO detran- MA
			</span>
			</form>
			</td>
			</tr>
			...
			<td width="221"  valign="top" class="td" ><br /></td>
			<td width="207"  valign="top" class="td"><br /></td>
			<td width="111" colspan="2" valign="top" class="td"><br />			
			  <br />			  <br /></td>
			</tr>
			<?php
			...
			</label>			  <?php echo $resultado['nome']; ?></td>
			<td class="td3" valign="top"><?php echo $resultado['email']; ?></td>
			<td valign="top" class="td3"><?php echo $resultado['telefone']; ?></td>
			<td valign="top" class="td3" align="center"><a href="#" onclick="MM_openBrWindow('trafego.php?id_aluno=<?php echo $resultado['id_aluno'] ?>','','scrollbars=yes,resizable=yes,width=400,height=320')"><img src="../img/trafego.jpg" /></a></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_trafego.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_trafego.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_trafego.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
