...
?>
			...
			<form name="form2" method="post" action="layout_aprovados.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;<span class="span7">ALUNOS APROVADOS NO EXAME DE LEGISLA&Ccedil;&Atilde;O </span>
			</form>
			</td>
			</tr>
			</table>
	   ...
	   echo $your_date;
	   ?></td>
        <td width="172" valign="top"  class="td"><font color="#666666"><?php echo $resultado['turno']; ?></td>
        
        <td width="82" align="left" valign="top"  class="td">
        <a href="#" 
        ...
        <tr><?php $cont ++; }?>
			...
			echo "<a class=\"pag\" href='layout_aprovados.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_aprovados.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_aprovados.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
