...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="497" align="center">
      ...
      <tr valign="baseline">
        <td width="132" align="right" nowrap="nowrap">Forma de Pagamento</td>
        <td width="353"><select name="fpagamento">
...
?>
      ...
      <tr valign="baseline">
        ...
        <td valign="top"><input type="radio" name="form_pg" id="radio" value="Pago com juros" />
Com Juros
  <input type="radio" name="form_pg" checked="checked" id="radio2" value="Pago sem juros" />
Sem Juros<br />
        <br /></td>
      </tr>
      <tr valign="baseline">
...
Com desconto
  <input type="radio" name="form_pg2" id="radio4" checked="checked" value="Sem desconto" />
Sem desconto<br />
<br /></td>
    </tr>
