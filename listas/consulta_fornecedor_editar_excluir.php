...
-->
			...
			if($_POST["chkDel"][$i] != "")
			{
			$strSQL = "DELETE FROM fornecedor ";
			$strSQL .="WHERE id_fornecedor = '".$_POST["chkDel"][$i]."' ";
			...
			<tr>
			<td>
			<form name="form2" method="post" action="layout_ed_excluir_fornecedor.php">
			<label>
			...
			<span class="span7">
			Editar e Excluir Fornecedor</span>
			</form>
			</td>
			</tr>
			</table>
			...
			<tr>
			<td width="243" valign="top"><label></label>
			...
			$sql = "SELECT * from fornecedor WHERE nome like '".$filtro."%' AND nome like '".$filtro1."%' ORDER BY id_fornecedor DESC ";
			...
			<td valign="top"><label>
			<input type="checkbox" name="chkDel[]" value="<?php echo $resultado["id_fornecedor"];?>">
			</label>			  <font color="#999999"><?php echo $resultado['nome']; ?></td>
			<td valign="top"><font color="#999999"><?php echo $resultado['cnpj']; ?></td>
			...
			<td valign="top"><div align="center"><a class="span8" href="#" onclick="MM_openBrWindow('editar_fornecedor.php?id_fornecedor=<?php echo $resultado['id_fornecedor']  ?>','','scrollbars=yes,resizable=yes,width=400,height=500')">Atualizar</a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			$sql_select_all = "select * from fornecedor";
			...
			echo "<a class=\"pag\" href='layout_ed_excluir_fornecedor.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_ed_excluir_fornecedor.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_ed_excluir_fornecedor.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
