			...
			<form name="form2" method="post" action="layout_situacao_aprovado_trafego.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;<span class="span7">ALUNOS APROVADOS NO EXAME DE TR&Aacute;FEGO</span>
			</form>
			</td>
			</tr>
			</table>
     ...
     $sql = "SELECT * from trafego WHERE status='1' and aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
      ...
      <?php
        ...
        echo "<a class=\"pag\" href='layout_situacao_aprovado_trafego.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='layout_situacao_aprovado_trafego.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='layout_situacao_aprovado_trafego.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
