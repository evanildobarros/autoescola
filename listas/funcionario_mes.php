...
$sql1 = @mysql_query("SELECT COUNT( * ) AS total1 ,usuario FROM acesso AS ace, alunos AS alu WHERE ace.usuario = alu.login GROUP BY alu.login");
$sql2 = @mysql_query("SELECT COUNT(*) as total2 FROM alunos");
