...
-->
			...
			if($_POST["chkDel"][$i] != "")
			{
			$strSQL = "DELETE FROM instrutor ";
			$strSQL .="WHERE id_instrutor = '".$_POST["chkDel"][$i]."' ";
			...
			<tr>
			<td>
			<form name="form2" method="post" action="layout_ed_excluir_instrutor.php">
			<label>
			...
			<span class="span7">
			Editar e Excluir Instrutor</span>
			</form>
			</td>
			</tr>
			</table>
			...
			<tr>
			<td width="365" valign="top"><label></label>
			...
			$sql = "SELECT * from instrutor WHERE nome like '".$filtro."%' ORDER BY id_instrutor DESC ";
			...
			<td valign="top"><label>
			<input type="checkbox" name="chkDel[]" value="<?php echo $resultado["id_instrutor"];?>">
			</label>			  <font color="#999999"><?php echo $resultado['nome']; ?></td>
			<td valign="top"><font color="#999999"><?php echo $resultado['endereco']; ?></td>
			<td valign="top"><?php echo $resultado['telefone']; ?></td>
			<td valign="top"><font color="#999999"><font color="#999999"><?php echo $resultado['email']; ?></td>
			<td valign="top"><font color="#999999"><?php echo $date = $resultado['apto']; ?></td>
			<td valign="top"><div align="center"><a class="span8" href="#" onclick="MM_openBrWindow('editar_instrutor.php?id_instrutor=<?php echo $resultado['id_instrutor']  ?>','','scrollbars=yes,resizable=yes,width=400,height=580')">Atualizar</a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			$sql_select_all = "select * from instrutor";
			...
			echo "<a class=\"pag\" href='layout_ed_excluir_instrutor.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_ed_excluir_instrutor.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_ed_excluir_instrutor.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
