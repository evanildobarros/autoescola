           ...
           <link rel="stylesheet" href="../css/paginacao.css" type="text/css" />
			...
			<form name="form2" method="post" action="layout_situacao_reprovados_trafego.php">
			<label>
			<input class="input"  type="text" name="filtro" id="filtro">
			</label>
			<label>
			<input class="botao" type="submit" name="button" id="button" value="Pesquisar">
			</label>
			&nbsp; &nbsp; &nbsp;<span class="span7">ALUNOS REPROVADOS NO EXAME DE TR&Aacute;FEGO</span>
			</form>
			</td>
			</tr>
			</table>
			...
			<table width="1000" align="center" class="td2" style="border-collapse:collapse;">
     ...
     $sql = "SELECT * from trafego WHERE status='2' and aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
      ...
      <?php
        ...
        echo "<a class=\"pag\" href='layout_situacao_reprovados_trafego.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='layout_situacao_reprovados_trafego.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='layout_situacao_reprovados_trafego.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
