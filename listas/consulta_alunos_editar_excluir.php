...
-->
			...
			<tr>
			<td>
			<form name="form2" method="post" action="layout_ed_excluir.php">
			<label>
			...
			<td width="237" valign="top" class=""><font color="#999999"><?php echo $resultado['nome']; ?></td>
			...
			<td valign="top"><div align="center"><a class="span8" href="#" onclick="MM_openBrWindow('editar_aluno.php?id_aluno=<?php echo $resultado['id_aluno']  ?>','','scrollbars=yes,resizable=yes,width=400,height=500')">Atualizar</a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_ed_excluir.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_ed_excluir.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_ed_excluir.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
