...
@session_start();
		require'../Connections/conexao.php';	
			...
			<form name="form2" method="post" action="layout_niver_mes.php">
			<label>
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;Anivers&aacute;riantes do m&ecirc;s</span>
			</form>
			</td>
			</tr>
			</table>
			...
			$filtro1 = $_REQUEST['filtro1'];
			  ...
			  $sql = "SELECT DISTINCT nome,telefone,email,(MONTH(CURDATE()) = MONTH(aniversario)) as niver FROM alunos HAVING niver";
    ...
    <td valign="top" class="td3"><span class="span6"><?php echo $resultado['nome']; ?></span></td>
...
<tr><?php $cont ++; }?>
			...
			echo "<a class=\"pag\" href='layout_niver_mes.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_niver_mes.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_niver_mes.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
