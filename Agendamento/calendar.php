...
//-->
        ...
        $event_title .= stripslashes("<a class=\"span8\" href=\"javascript:abrir('../Agendamento/cliente.php?id=".$ev["id"]."');\">".$ev["aluno"]."</a>")."<br/> ";
        
        $event_title .= stripslashes("<font color=\"#666\"><font color=\"#00CC66\"><strong> &radic;</strong></font> ".$ev["hora"]."</font>");
        $event_title .= stripslashes(" <font color=\"#666\">	ás ".$ev["event_shortdesc"])."</font>"."<a class=\"span8\" href=\"javascript:abrir2('../Agendamento/excluir.php?id=".$ev["id"]."');\">".X."</a>"."<hr />";
        ...
        echo "<td valign=\"top\"><a class=\"alink\" href=\"#\" onclick=\"MM_openBrWindow('../Agendamento/event.php?m=".$month."&d=".$dayArray["mday"]."&y=$year;','','scrollbars=yes,resizable=yes,width=750,height=400')\">"."<span class\"alink\">".$dayArray["mday"]."</span>"."<span class=\"numero\"><font color\"Red\">Reservar</font></span> "."</a><br/></br>"."<span class=\"nome\"><font color\"Red\">".$event_title."</td>\n"."</font></span>";
